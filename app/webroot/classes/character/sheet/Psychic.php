...
class Psychic extends SheetRenderer
{
                           ...
                           $attribute_table, $show_sheet_table)
    {
        ...
        // psychic powers
        $powers = $sheet->getPowers($sheet->stats['id'], 'PsychicMerit', WodSheet::NOTELEVEL, 3);

        ob_start();
        ?>
        <table class="character-sheet <?php echo $sheet->table_class; ?>" id="psychic_merit_list">
            <tr>
                <th colspan="3">
                    Psychic Merits
                    <?php if ($sheet->viewOptions['edit_powers']): ?>
                        <a href="#" onClick="addPsychicMerit();return false;">
            ...
            <?php foreach ($powers as $i => $power): ?>
                ...
                <tr>
                    <td>
                        <?php if ($sheet->viewOptions['edit_powers']): ?>
                            <label for="psychicmerit<?php echo $i; ?>_name"></label><input type="text"
                                                                                           name="psychicmerit<?php echo $i; ?>_name"
                                                                                           id="psychicmerit<?php echo $i; ?>_name"
                                                                                           size="15"
                    ...
                    <td>
                        <?php if ($sheet->viewOptions['edit_powers']): ?>
                            <label for="psychicmerit<?php echo $i; ?>_note"></label><input type="text"
                                                                                           name="psychicmerit<?php echo $i; ?>_note"
                                                                                           id="psychicmerit<?php echo $i; ?>_note"
                                                                                           size="15"
                    ...
                    <td>
                        <?php echo $dots; ?>
                        <input type="hidden" name="psychicmerit<?php echo $i; ?>_id"
                               id="psychicmerit<?php echo $i; ?>_id"
        ...
        <?php
        $psychic_merits_list = ob_get_clean();

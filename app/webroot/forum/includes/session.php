	...
	*/
	function session_begin($update_session_page = true)
	{
		...
		if (!empty($this->session_id))
		{
            ...
            $permissions = $this->getLegacyPermisisons($this->data['user_id'], $db);
...
//				$this->session_create(ANONYMOUS);
	...
	*/
    ...
    private function getLegacyPermisisons($userId, $db)
    {
        ...
        $data['is_asst'] = ($gm_permissions_detail['Is_Asst'] == "Y") ? true : false;
        $data['is_gm'] = ($gm_permissions_detail['Is_GM'] == "Y") ? true : false;
        $data['is_head'] = ($gm_permissions_detail['Is_Head'] == "Y") ? true : false;
        $data['is_admin'] = ($gm_permissions_detail['Is_Admin'] == "Y") ? true : false;
        $data['site_id'] = $gm_permissions_detail['Site_ID'];

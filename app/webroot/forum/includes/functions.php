...
function phpbb_check_hash($password, $hash)
{
	...
	if (strlen($hash) == 34)
	{
		//echo _hash_crypt_private($password, $hash, $itoa64) . ' : ' . $hash . '<br />';
...
function page_header($page_title = '', $display_online_list = true, $item_id = 0, $item = 'forum')
{
	...
	$template->assign_vars(array(
        ...
        'CURRENT_TIME_MICRO'            => microtime(true),
        ...
        'IS_STORYTELLER'        => ((isset($user->data['is_asst']) && ($user->data['is_asst'] == 'Y')) || (isset($user->data['is_gm']) && ($user->data['is_gm'] == 'Y')) || (isset($user->data['is_head']) && ($user->data['is_head'] == 'Y')) || (isset($user->data['is_admin']) && ($user->data['is_admin'] == 'Y'))),

...
## set group patterns
$GroupPattern = '(?:Players|CityBook|Profiles|GameRef|PmWiki|Site|Main|SideGames|Archive)';
$isST = false;
if(($userdata['is_asst'] || $userdata['is_gm'] || $userdata['wiki_manager']|| $userdata['is_head'] || $userdata['is_admin']) && (!$userdata['cell_id']))
{
  $isST = true;
  $GroupPattern = '(?:Players|CityBook|Profiles|GameRef|PmWiki|Site|Main|SideGames|Archive|Storytellers)';
}
...
##  To enable markup syntax from the Creole common wiki3.0 markup language

...
if(/*$userdata['is_asst'] || $userdata['is_gm'] || */$userdata['is_head'] || $user_data['is_admin'])
{
  $admin_commands = <<<EOQ
<form>
  ...
  <input type="hidden" id="information" name="information" value="" class="information">
</form>
EOQ;
...
$page_content = <<<EOQ
<div class="title">Map of Districts and Sites for The City</div>

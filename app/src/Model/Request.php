 ...
 */
	public $hasMany = array(
		...
		'RequestStatusHistory' => array(
			'className' => 'RequestStatusHistory',
			'foreignKey' => 'request_id',
			'dependent' => false,
			'conditions' => '',
			'fields' => '',

...
<html>
<title>Pro Chat Rooms - Version <?php echo $CONFIG['version'];?> - Share Files Installation</title>
<head>
...
<div style="padding-top:20px;padding-bottom:20px;width:100%;text-align:center;font-family: Arial, Verdana;font-size: 14px;">
	<b>Pro Chat Rooms - Version <?php echo $CONFIG['version'];?> - Share Files Installation</b>
</div>
...
<?php if ($_POST && $_POST['i']=='2'){?>
	...
	<tr><td align=center>
		...
		<br>
		<br>
		<b>Install Share Files Plugin</b>
		<br>
		<br>
...
<?php if ($_POST && $_POST['i']=='3'){?>
	...
	*/
	...
	try {
		$dbh = db_connect();
		$params = array('');
		$query = "CREATE TABLE IF NOT EXISTS `prochatrooms_share` (
		...
		{
			echo "&#187; prochatrooms_share - <font color=\"#33FF00\"><b>INSTALLED</b></font>";
		}	
	...
	<tr><td>
	If all tables have successfully installed, please delete the folder '<b>plugins/share/install</b>'. 
	</td></tr>
	<tr><td>&nbsp;</td></tr>
	<tr><td>&nbsp;</td></tr>

...
class CharactersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'is_sanctioned' => ['type' => 'string', 'fixed' => true, 'length' => 2, 'null' => true, 'default' => '', 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        'asst_sanctioned' => ['type' => 'string', 'fixed' => true, 'length' => 2, 'null' => true, 'default' => '', 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        'is_deleted' => ['type' => 'string', 'length' => null, 'null' => false, 'default' => 'N', 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            ...
            'Is_Sanctioned' => ['type' => 'index', 'columns' => ['is_sanctioned'], 'length' => []],

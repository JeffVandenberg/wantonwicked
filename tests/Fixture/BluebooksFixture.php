 ...
 *
 */
class BluebooksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            ...
            'created_by_id' => ['type' => 'index', 'columns' => ['created_by_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created_by_id' => 1,
                'created_on' => '2018-07-30 21:44:24',
                'updated_by_id' => 1,
                'updated_on' => '2018-07-30 21:44:24'
            ],
        ];
        parent::init();
    }

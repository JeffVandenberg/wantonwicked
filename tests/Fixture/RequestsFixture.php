...
class RequestsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'request_type_id' => ['type' => 'integer', 'length' => 3, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'request_status_id' => ['type' => 'integer', 'length' => 3, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'character_id' => ['type' => 'index', 'columns' => ['character_id', 'request_type_id', 'request_status_id'], 'length' => []],
            'request_status' => ['type' => 'index', 'columns' => ['request_status_id', 'request_type_id'], 'length' => []],
            'created_by_id_index' => ['type' => 'index', 'columns' => ['created_by_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'request_status_id' => 1,
            'created_by_id' => 1,
            'created_on' => '2018-01-27 23:26:39',
            'updated_by_id' => 1,
            'updated_on' => '2018-01-27 23:26:39'
        ],
    ];
}

...
class ScenesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'summary' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'run_by_id' => ['type' => 'integer', 'length' => 10, 'unsigned' => true, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'run_on_date' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        ...
        'scene_status_id' => ['type' => 'integer', 'length' => 5, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_indexes' => [
            'run_by_id' => ['type' => 'index', 'columns' => ['run_by_id'], 'length' => []],
            'slug_index' => ['type' => 'index', 'columns' => ['slug'], 'length' => []],
            'run_on_date_index' => ['type' => 'index', 'columns' => ['run_on_date'], 'length' => []],
            'scene_status_id_index' => ['type' => 'index', 'columns' => ['scene_status_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'run_by_id' => 1,
            'run_on_date' => '2017-03-17 00:55:28',
            'description' => 'Lorem ipsum dolor sit amet, aliquet feugiat. Convallis morbi fringilla gravida, phasellus feugiat dapibus velit nunc, pulvinar eget sollicitudin venenatis cum nullam, vivamus ut a sed, mollitia lectus. Nulla vestibulum massa neque ut et, id hendrerit sit, feugiat in taciti enim proin nibh, tempor dignissim, rhoncus duis vestibulum nunc mattis convallis.',
            'created_by_id' => 1,
            'created_on' => '2017-03-17 00:55:28',
            'updated_by_id' => 1,
            'updated_on' => '2017-03-17 00:55:28',

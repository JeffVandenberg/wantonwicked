...
if($topic_data['forum_op_only_view'] && $user->data['user_id'] != $topic_data['topic_poster'] && $topic_data['topic_type'] != POST_STICKY && $topic_data['topic_type'] != POST_ANNOUNCE && $topic_data['topic_type'] != POST_GLOBAL && !$auth->acl_get('f_op_only_view', $forum_id))
{
